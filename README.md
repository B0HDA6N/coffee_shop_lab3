# ☕ Coffee Shop App - Лабораторна робота №3

## 📝 Опис проєкту
Цей проєкт є реалізацією інтерфейсу мобільного додатка для кав'ярні на базі фреймворку **Flutter**. Весь макет зверстаний вручну з повним дотриманням відступів, шрифтів, кольорів та іконок, зазначених у дизайні. Використання інструментів автоматичної конвертації було заборонено.
...
## 📱 Реалізовані екрани
У межах роботи було створено 7 унікальних екранів:
